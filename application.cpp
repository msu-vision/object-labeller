...
Application::Application(QWidget *parent_) :
    QWidget(parent_), dirname_(), filenames_(), saveFilename_(), fileInd_(0),
    area_(nullptr), countLabel_(nullptr),
    prevButton_(nullptr), nextButton_(nullptr),
    nextShortcut_(nullptr), prevShortcut_(nullptr)
{
